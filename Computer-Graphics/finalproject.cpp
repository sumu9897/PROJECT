...
void handleMouse(int button, int state, int x, int y) {
	if (position1 == GLUT_LEFT_BUTTON)
	{	speed += 0.1f;
			}
if (position1  == GLUT_RIGHT_BUTTON)
	{speed -= 0.1f;   }
glutPostRedisplay();}
...
glBegin(GL_QUADS);
    ...
    glVertex2i(a+110,b+340);
    glVertex2i(a+110,b+370);
glEnd();

glBegin(GL_QUADS);
    glColor3f(1.0,0.5,0.0);
    glVertex2i(a+110,b+280);
    glVertex2i(a+240,b+280);
    glVertex2i(a+240,b+320);
    glVertex2i(a+110,b+320);


glEnd();

  glColor3f(1.0,1.0,1.0);
		char string[]="Roadside Fuchka";
		glRasterPos2f(a+115,b+300);
...
glBegin(GL_QUADS);// When We Select D this value will be Display
    glColor3ub(102, 102, 255);// Day Sky Color
...
glEnd();
    ...
    GLint y7= 640;
    GLfloat radius7 =35;
    int triangleAmount7 = 35;

    GLfloat twicePi7 = 2.0f * PI;

    glBegin(GL_TRIANGLE_FAN);
    glColor3ub(255, 50, 102);// Sun Color
...
void man(int x, int y )// For Human
{
...
void man1(int x, int y )//For Human
{

    //Head
glBegin(GL_QUADS);
    glColor3d(220, 170, 50);
    glVertex2i(x+1,y+18);
    glVertex2i(x+8,y+18);
    glVertex2i(x+8,y+22);
    glVertex2i(x+1,y+22);
...
void wheel (int a, int b)//For Wheel
{
    int i;
    GLint x= a+20;
    GLint y= b+65;
...
void car1(int a, int b)//For Car
{
 glBegin(GL_QUADS);//Car1 Button View
    glColor3f(0.50, 0.0, 0.0);//Red Car
...
glBegin(GL_QUADS);//Car 1 windows view
    glColor3f(0.0, 0.0, 0.0);
...
void car3(int a, int b)//For Car
{
 glBegin(GL_QUADS);//Yellow Car
    glColor3f(255.0, 150.0, 0.0);
    glVertex2i(a+300, b+90);
    glVertex2i(a+450, b+90);
    glVertex2i(a+450, b+120);
...
void car4(int a, int b)//For Car
{
 glBegin(GL_QUADS);// Car Skyblue
    glColor3f(0.0, 150.0, 255.0);
...
void tree(int x, int y)// Big tree
{
...
void carmove()
{
    ...
    xm-=0.0001;// Rickshaw move Speed

        	if(m>15.0)
	{
		m= 0.0;
	}
    m+=0.01;//Fuscka Man movement

    	if(k>1200.0)
	{
		k= -5.0;
	}
    k+=0.00008;// Man walking Speed
...
void myDisplay(void)
{
    ...
    GLint y8= 620;
    GLfloat radius8 =28;
    int triangleAmount8 = 28;

    GLfloat twicePi8 = 2.0f * PI;

glBegin(GL_TRIANGLE_FAN);
    glColor3ub(224, 224, 224);// Moon Color
    glVertex2f(x8, y8);
...
day(q,w);// Day BackGround


glBegin(GL_QUADS);// Green Field
...
glColor3ub(102, 102, 255);
	...
	glVertex2i(210,660);//1st
	glVertex2i(220,670);//2nd
	glVertex2i(240,660);//3rd
	glVertex2i(250,650);//4th

    glVertex2i(250,670);//5th
	glVertex2i(260,640);//6th
    glVertex2i(270,660);//7th
    glVertex2i(280,650);//8th

    glVertex2i(280,670);//9th
	glVertex2i(290,640);//10th
    glVertex2i(310,640);//11
    glVertex2i(310,660);//12

	glVertex2i(320,650);//13
	glVertex2i(320,670);//14
	glVertex2i(340,660);//15
    glVertex2i(350,650);//16

    glVertex2i(350,670);//17
	glVertex2i(360,640);//18
    glVertex2i(380,650);//19
	glVertex2i(390,640);//20

    glVertex2i(410,640);//21
    glVertex2i(420,650);//22
    glVertex2i(480,670);//23
	glVertex2i(470,660);//24

    glVertex2i(610,660);//25
    glVertex2i(620,670);//26
    glVertex2i(650,650);//27
    glVertex2i(660,640);//28

	glVertex2i(640,660);//29
    glVertex2i(650,670);//30
    glVertex2i(680,650);//31
	glVertex2i(690,640);//32

	glVertex2i(710,640);//33
    glVertex2i(720,650);//34
	glVertex2i(770,660);//35
    glVertex2i(780,670);//36

    glVertex2i(810,640);//37
    glVertex2i(820,650);//38
	glVertex2i(840,670);//39
    glVertex2i(860,640);//40
...
glTranslatef(position1,0.0f, 0.0f);
    ...
    glColor3ub(224, 224, 224);
    glVertex2f(xi3, yi3);
    for(ii3 = 0; ii3 <= triangleAmounti3; ii3++)
    {
        glVertex2f(
            xi3 + (radiusi3 * cos(ii3 *  twicePii3 / triangleAmounti3)),
            yi3 + (radiusi3 * sin(ii3 * twicePii3 / triangleAmounti3))
        );
    }
    glEnd();
    ...
    glColor3ub(224, 224, 224);
    glVertex2f(xi4, yi4);
    for(ii4 = 0; ii4 <= triangleAmounti4; ii4++)
    {
        glVertex2f(
            xi4 + (radiusi4 * cos(ii4 *  twicePii4 / triangleAmounti4)),
            yi4 + (radiusi4 * sin(ii4 * twicePii4 / triangleAmounti4))
        );
    }
    glEnd();
    ...
    glColor3ub(224, 224, 224);
    glVertex2f(xi5, yi5);
    for(ii5 = 0; ii5 <= triangleAmounti5; ii5++)
    {
        glVertex2f(
            xi5 + (radiusi5 * cos(ii5 *  twicePii5 / triangleAmounti5)),
            yi5 + (radiusi5 * sin(ii5 * twicePii5 / triangleAmounti5))
        );
    }
    glEnd();
    ...
    glColor3ub(224, 224, 224);
    glVertex2f(xi6, yi6);
    for(ii6 = 0; ii6 <= triangleAmounti6; ii6++)
    {
        glVertex2f(
            xi6 + (radiusi6 * cos(ii6 *  twicePii6 / triangleAmounti6)),
            yi6 + (radiusi6 * sin(ii6 * twicePii6 / triangleAmounti6))
        );
    }
    glEnd();
...
glEnd();
    ...
    glPushMatrix();
    glTranslatef(+30, -30, 0);// bird number 7
    ...
    glPopMatrix();
     ...
     glPushMatrix();
    glTranslatef(+0, -60, 0);// bird number 6
...
// Parliament Main Work from Here
//middle
glBegin(GL_QUADS);// Ayon Vai Door bole dise
	glColor3ub(64, 64, 64);
	glVertex2i(610,630);
	glVertex2i(610,430);
	glVertex2i(550,430);
...
glBegin(GL_QUADS);// Right 1 Building
	glColor3ub(192, 192, 192);
	glVertex2i(610,630);
	glVertex2i(610,430);
	glVertex2i(710,430);
...
glBegin(GL_QUADS);// Right 1 and 2  middle speace
...
glBegin(GL_LINES);// Right 2 line 1
	glColor3ub(255, 255, 255);
    glVertex2i(790, 610);
    glVertex2i(715, 600);
glEnd();

glBegin(GL_LINES);// Right 2 line 2
	glColor3ub(255, 255, 255);
    glVertex2i(790, 595);
    glVertex2i(710, 585);
glEnd();

glBegin(GL_LINES);// Right 2 line 3
	glColor3ub(255, 255, 255);
    glVertex2i(790, 580);
    glVertex2i(710, 570);
glEnd();

glBegin(GL_LINES);// Right 2 line 4
	glColor3ub(255, 255, 255);
    glVertex2i(790, 565);
    glVertex2i(710, 555);
glEnd();

glBegin(GL_LINES);// Right 2 line 5
	glColor3ub(255, 255, 255);
    glVertex2i(790, 550);
    glVertex2i(710, 540);
glEnd();

glBegin(GL_LINES);// Right 2 line 6
	glColor3ub(255, 255, 255);
    glVertex2i(790, 535);
    glVertex2i(710, 525);
glEnd();

glBegin(GL_LINES);// Right 2 line 7
	glColor3ub(255, 255, 255);
    glVertex2i(790, 520);
    glVertex2i(710, 510);
glEnd();

glBegin(GL_LINES);// Right 2 line 8
	glColor3ub(255, 255, 255);
    glVertex2i(790, 505);
    glVertex2i(710, 495);
glEnd();

glBegin(GL_LINES);// Right 2 line 9
	glColor3ub(255, 255, 255);
    glVertex2i(790, 490);
    glVertex2i(710, 480);
glEnd();

glBegin(GL_LINES);// Right 2 line 10
	glColor3ub(255, 255, 255);
    glVertex2i(790, 475);
    glVertex2i(710, 465);
glEnd();

glBegin(GL_LINES);// Right 2 line 11
	glColor3ub(255, 255, 255);
    glVertex2i(790, 460);
    glVertex2i(710, 450);
glEnd();
...
glBegin(GL_QUADS);// Right 3 building
	glColor3ub(192, 192, 192);
	glVertex2i(790,610);
	glVertex2i(870,600);
	glVertex2i(870,430);
...
glEnd();
   ...
   glEnd();
	...
	glBegin(GL_QUADS);// Right 4 Building
	glColor3ub(192, 192, 192);
	glVertex2i(880,600);
	glVertex2i(960,590);
	glVertex2i(960,430);
    ...
    glBegin(GL_TRIANGLES);// Right 4 Building Triangles Disingin
   glColor3ub(128, 128, 128);
   glVertex2i(890, 480);
   glVertex2i(915, 590);
   glVertex2i(940, 480);
   glEnd();
    ...
    glBegin(GL_QUADS);// Right 4 Building Ground Disingin
	glColor3ub(128, 128, 128);
	glVertex2i(890,460);
	glVertex2i(940,460);
	glVertex2i(940,430);
	...
	glBegin(GL_QUADS);// Right buliding 4-5
	glColor3ub(160, 160, 160);
	glVertex2i(960,580);
	glVertex2i(970,580);
	glVertex2i(970,430);
	...
	glBegin(GL_QUADS);// Right 5 Buliding
	glColor3ub(192, 192, 192);
	glVertex2i(970,580);
	glVertex2i(1050,580);
	glVertex2i(1050,430);
...
glBegin(GL_QUADS);// 2 Left Building
	glColor3ub(192, 192, 192);
	glVertex2i(450,600);
	glVertex2i(450,430);
	glVertex2i(370,430);
...
glBegin(GL_QUADS);// Left 1-2 Building Design
	glColor3ub(160, 160, 160);
	glVertex2i(450,600);
	glVertex2i(445,600);
	glVertex2i(445,430);
...
glBegin(GL_QUADS);// Left 3 Building Design
	glColor3ub(192, 192, 192);
	glVertex2i(370,610);
	glVertex2i(370,430);
	glVertex2i(290,430);
...
glBegin(GL_QUADS);// Left 4th Building
	glColor3ub(192, 192, 192);
	glVertex2i(280,600);
	glVertex2i(280,430);
	glVertex2i(200,430);
...
glBegin(GL_QUADS);// Left 5th Building Disign
	glColor3ub(192, 192, 192);
	glVertex2i(190,580);
	glVertex2i(190,430);
	glVertex2i(110,430);
...
//Lamp Stand
glBegin(GL_QUADS);//1st Lamp Stand
	glColor3ub(32, 32, 32);
	glVertex2i(110,360);
	glVertex2i(120,360);
	glVertex2i(120,310);
...
glBegin(GL_QUADS);//2nd Lamp Stand
	glColor3ub(32, 32, 32);
	glVertex2i(310,360);
	glVertex2i(320,360);
	glVertex2i(320,310);
...
glBegin(GL_QUADS);//3rd lamp Stand
	glColor3ub(34, 34, 34);
	glVertex2i(510,360);
	glVertex2i(520,360);
	glVertex2i(520,310);
...
glBegin(GL_QUADS);//4th Lamp Stand
	glColor3ub(34, 34, 34);
	glVertex2i(710,360);
	glVertex2i(720,360);
	glVertex2i(720,310);
...
glBegin(GL_QUADS);//5th lamp Stand
	glColor3ub(34, 34, 34);
	glVertex2i(910,380);
	glVertex2i(920,380);
	glVertex2i(920,310);
...
glBegin(GL_QUADS);//6th lamp Stand
	glColor3ub(34, 34, 34);
	glVertex2i(1110,380);
	glVertex2i(1120,380);
	glVertex2i(1120,310);
...
glBegin(GL_TRIANGLES);// small 1st number tree
   glColor3ub(0, 153, 0);
   glVertex2i(50, 350);
   glVertex2i(70, 380);
   glVertex2i(90, 350);
...
glBegin(GL_TRIANGLES);// small 2nd number tree
   glColor3ub(0, 153, 0);
   glVertex2i(250, 350);
   glVertex2i(270, 380);
   glVertex2i(290, 350);
...
glBegin(GL_TRIANGLES);// small 3rd number tree
   glColor3ub(0, 153, 0);
   glVertex2i(450, 350);
   glVertex2i(470, 380);
   glVertex2i(490, 350);
...
glBegin(GL_TRIANGLES);// small 4th number tree
   glColor3ub(0, 153, 0);
   glVertex2i(650, 350);
   glVertex2i(670, 380);
   glVertex2i(690, 350);
...
glBegin(GL_TRIANGLES);// small 5th number tree
   glColor3ub(0, 153, 0);
   glVertex2i(850, 350);
   glVertex2i(870, 380);
   glVertex2i(890, 350);
...
glBegin(GL_TRIANGLES);//small 6th number tree
   glColor3ub(0, 153, 0);
   glVertex2i(1050, 350);
   glVertex2i(1070, 380);
   glVertex2i(1090, 350);
...
for (c=0; c<=1200; c+=40)// Road Side Grass
{
    grass(c,v);
}

	for (c=0; c<=1200; c+=40)// parlament side grass
{
    grass(c,v+290);
}
    glBegin(GL_QUADS);
...
glBegin(GL_QUADS);//Bariket upper line
	glColor3ub(139, 0, 0);
	glVertex2i(0,310);
	glVertex2i(0,300);
	glVertex2i(1200,300);
...
GLint xx;// Bariket 2nd to last line
...
car(xn,yq);
car1(xn,yq);// Red Color  Car
car2(xn+400,yq-30);//Blue Color Car
car3(xn+650,yq);// Yellow Color Car
car4(xm+250,yp+55);// Magenta color Car
...
wheel(xm+180,yp+110);//front wheel in richshaw
wheel(xm+270,yp+115);//back left wheel in richshaw
wheel(xm+255,yp+120);//back right wheel in richshaw


wheel(xm+570,yp+130);// Car Skyblue
wheel(xm+650,yp+130);

tree(s-470,t+50);// Big tree
tree(s+700,t+50);
tree(s+650,t+50);

lamp(q,w);// Light off commend or light will be on always
glFlush ();
}
